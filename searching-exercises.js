console.log("epic sauce possum awesome");
...
let array = dataset.split(' ');
const data = array.map(number => parseInt(number));
const sortData = data.sort(sortNumber);
console.log(sortData);

function findValue(dataset, value) {
...
console.log(findValue(dataset, 30)); // 1
